...
# define rtmGetModelMappingInfo(rtm)   ()
#endif

#ifndef rtmSetModelMappingInfo
# define rtmSetModelMappingInfo(rtm, val) ()
#endif
...
#define Subsystem_rtModel              RT_MODEL_Subsystem
...
} ContinuousStates_Subsystem;

/* State derivatives (auto storage) */
typedef struct {
  real_T Integrator1_CSTATE;           /* '<S1>/Integrator1' */
  real_T Integrator_CSTATE;            /* '<S1>/Integrator' */
} StateDerivatives_Subsystem;

/* State disabled  */
typedef struct {
  boolean_T Integrator1_CSTATE;        /* '<S1>/Integrator1' */
  boolean_T Integrator_CSTATE;         /* '<S1>/Integrator' */
} StateDisabled_Subsystem;
...
struct Parameters_Subsystem_ {
  real_T Integrator1_IC;               /* Expression: (fi0*pi)/180
                                        * Referenced by: '<S1>/Integrator1'
                                        */
  real_T Gain1_Gain;                   /* Expression: g/l
                                        * Referenced by: '<S1>/Gain1'
                                        */
  real_T Integrator_IC;                /* Expression: 0
                                        * Referenced by: '<S1>/Integrator'
                                        */
  real_T Gain_Gain;                    /* Expression: k/m
...
/* Continuous states (auto storage) */
extern ContinuousStates_Subsystem Subsystem_X;
...
extern struct RT_MODEL_Subsystem *const Subsystem_M;
 ...
 *
 * hilite_system('model2lab2/Subsystem')    - opens subsystem model2lab2/Subsystem
 * hilite_system('model2lab2/Subsystem/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'model2lab2'
 * '<S1>'   : 'model2lab2/Subsystem'
 */
